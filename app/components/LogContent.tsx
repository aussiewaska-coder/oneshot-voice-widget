...
export function LogContent({
  ...
  return (
    <div className="flex flex-col h-full bg-transparent">
        ...
        <div className="border-b border-white/8 px-6 py-3 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-3 py-2 rounded text-xs bg-white/10 hover:bg-white/20 disabled:opacity-30 disabled:cursor-not-allowed transition-all min-w-12 min-h-12 flex items-center justify-center"
              aria-label="Decrease font size"
            >
              −
            </button>
            <span className="text-xs text-white/70 min-w-12 text-center">{fontSizePercent}%</span>
            <button
      ...
      <div
        ref={containerRef}
        className={`flex-1 overflow-y-auto space-y-1 font-ubuntu ${
